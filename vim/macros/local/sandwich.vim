" config for vim-sandwich. Here because needs to load _before_ vim-sandwich,
" but i want it together so i can switch off loading it if not loading
" vim-sandwich.
"
" Copied from https://github.com/machakann/vim-sandwich/blob/master/macros/sandwich/keymap/surround.vim
